    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 flex min-h-screen flex-col justify-end">
        <div className="mx-auto max-w-md w-full p-6 text-white">
          <h1 className="text-4xl font-extrabold tracking-tight drop-shadow">Nivaran</h1>
          <p className="mt-2 opacity-90 drop-shadow">Bettering shared issues. Create an account to get started today!</p>
